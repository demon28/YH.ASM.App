...
//工单类型
export function Power_Typelist() {
...
//工单类型
export function Support_Typelist() {
...
//工单优先级
export function Support_Prioritylist() {
...
//流程节点
export function Support_Statuslist() {
...
//工单严重度
export function Support_Severitylist() {
...
//取值工单类型
export function EnumGetSingle(value,Array) {
